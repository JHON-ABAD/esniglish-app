...
// ¡AQUÍ ESTÁ EL TRUCO! Añadimos Sparkles a la lista de importaciones
import { Book, BookOpen, Languages, Download, Cloud, AlertCircle, GraduationCap, ShieldCheck, Sparkles, Lightbulb } from 'lucide-react';

export default function Navbar({ activeTab, setActiveTab, syncStatus, exportData, setShowAdminPanel, isAdmin }) {
    ...
    <nav className="bg-white/80 backdrop-blur-md border-b border-slate-200 sticky top-0 z-30 shadow-sm">
      <div className="max-w-6xl mx-auto px-6 py-4 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-extrabold tracking-tight text-slate-900 leading-none">ESPANGLISH</h1>
        ...
        {/* Indicador Admin y Botón Exportar */}
        <div className="hidden md:flex items-center gap-3">
          ...
          <button onClick={exportData} className="flex items-center gap-2 px-4 py-2 bg-slate-50 hover:bg-slate-100 rounded-lg text-[13px] font-bold border border-slate-200 text-slate-700 transition-colors shadow-sm">
